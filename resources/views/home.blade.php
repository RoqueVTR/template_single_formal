            ...
            <div class="wrapper hm-black-strong">
                <div class="full-bg-img flex-center">
                    <ul class="animated fadeInUp col-md-12">
                        ...
                        <li>
                            <a href="#contact" class="btn btn-outline-white btn-lg page-scroll">Contact us</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="carousel-item">
            <div class="wrapper hm-black-strong">
                <div class="full-bg-img flex-center">
                    <ul class="animated fadeInUp col-md-12">
                        <li>
                            <h1 class="h1-responsive">See our growing list of clients</h1>
                        </li>
                        <li>
                            <a href="#clients" class="btn btn-outline-white btn-lg page-scroll">Our Clients</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="carousel-item">
            <div class="wrapper hm-black-strong">
                <div class="full-bg-img flex-center">
                    <ul class="animated fadeInUp col-md-12">
                        <li>
                            <h1 class="h1-responsive">We offer state of the art services and products</h1>
						</li>
                        <li>
                            <a href="#services" class="btn btn-outline-white btn-lg page-scroll">Our Services</a>
                        </li>
                    </ul>
                </div>
            </div>
